...
export const products = [
  { id: 1, name: 'Gratidão!', slug: 'gratidao-off-white', price: 59.9, priceCard: 69.9, collection: 'feminina', category: 'feminina', sizes: ['P'], colors: ['Off White'], image: '/images/products/feminina/gratidao-off-white.webp', description: 'Camiseta feminina baby look Off White com estampa "Gratidão!". 100% algodão premium.', featured: true, bestseller: true },
  ...
  { id: 6, name: 'Seja Luz', slug: 'seja-luz-preta', price: 59.9, priceCard: 69.9, collection: 'feminina', category: 'feminina', sizes: ['G', 'GG'], colors: ['Preto'], image: '/images/products/feminina/seja-luz-preta.webp', description: 'Camiseta feminina preta com lettering dourado "Seja Luz".', featured: true, bestseller: true },
  { id: 7, name: 'Feliz a Nação', slug: 'feliz-a-nacao-azul', price: 59.9, priceCard: 69.9, collection: 'feminina', category: 'feminina', sizes: ['G2'], colors: ['Azul'], image: '/images/products/feminina/feliz-a-nacao-azul.webp', description: 'Camiseta feminina azul "Feliz a nação cujo Deus é o Senhor".', featured: false, bestseller: false },
  ...
  { id: 22, name: 'Batimento Coração Pink', slug: 'batimento-coracao-pink', price: 59.9, priceCard: 69.9, collection: 'feminina', category: 'feminina', sizes: ['M', 'G'], colors: ['Rosa Pink'], image: '/images/products/feminina/batimento-coracao-pink.webp', description: 'Camiseta feminina rosa pink com batimento e cruz dourados.', featured: false, bestseller: false },
  { id: 23, name: 'Jesus Lives In Me Pink', slug: 'jesus-lives-in-me-pink', price: 59.9, priceCard: 69.9, collection: 'feminina', category: 'feminina', sizes: ['G'], colors: ['Rosa Pink'], image: '/images/products/feminina/jesus-lives-in-me-pink.webp', description: 'Camiseta feminina rosa pink "JESUS lives in me".', featured: false, bestseller: false },
  ...
  { id: 28, name: 'Lisa Azul', slug: 'lisa-azul-masculina', price: 49.9, priceCard: 59.9, collection: 'masculina', category: 'masculina', sizes: ['P', 'M'], colors: ['Azul'], image: '/images/products/masculina/lisa-azul-masculina.webp', description: 'Camiseta masculina lisa azul premium.', featured: false, bestseller: false },
  ...
  { id: 34, name: 'Jesus Lives In Me', slug: 'jesus-lives-in-me-preta-masc', price: 59.9, priceCard: 69.9, collection: 'masculina', category: 'masculina', sizes: ['G'], colors: ['Preto'], image: '/images/products/masculina/jesus-lives-in-me-preta-masc.webp', description: 'Camiseta masculina preta "icone JESUS" dourado.', featured: true, bestseller: true },
  ...
  { id: 37, name: 'Escudo da Fé', slug: 'escudo-da-fe-off-white', price: 59.9, priceCard: 69.9, collection: 'masculina', category: 'masculina', sizes: ['M', 'G'], colors: ['Off White'], image: '/images/products/masculina/escudo-da-fe-off-white.webp', description: 'Camiseta masculina Off White com escudo da fé.', featured: false, bestseller: false },
  ...
  { id: 46, name: 'O Choro Dura Uma Noite', slug: 'choro-dura-uma-noite-preta', price: 99.9, priceCard: 109.9, collection: 'oversized', category: 'oversized', sizes: ['M', 'G', 'GG'], colors: ['Preto'], image: '/images/products/oversized/choro-dura-uma-noite-preta.webp', description: 'Oversized preta "O choro dura uma noite, a alegria vem pela manhã".', featured: true, bestseller: true },
  { id: 47, name: 'O Choro Dura Uma Noite', slug: 'choro-dura-uma-noite-marrom', price: 99.9, priceCard: 109.9, collection: 'oversized', category: 'oversized', sizes: ['G'], colors: ['Marrom'], image: '/images/products/oversized/choro-dura-uma-noite-marrom.webp', description: 'Oversized marrom "O choro dura uma noite, a alegria vem pela manhã".', featured: true, bestseller: false },
  { id: 48, name: 'Jesus Loves You', slug: 'jesus-loves-you-preta', price: 99.9, priceCard: 109.9, collection: 'oversized', category: 'oversized', sizes: ['P', 'M', 'G'], colors: ['Preto'], image: '/images/products/oversized/jesus-loves-you-preta.webp', description: 'Oversized preta full coração "JESUS LOVES YOU".', featured: true, bestseller: true },
  { id: 49, name: 'God Is Good All The Time', slug: 'god-is-good-all-the-time-marrom', price: 99.9, priceCard: 109.9, collection: 'oversized', category: 'oversized', sizes: ['M', 'G', 'GG'], colors: ['Marrom'], image: '/images/products/oversized/god-is-good-all-the-time-marrom.webp', description: 'Oversized marrom "GOD IS GOOD ALL THE TIME".', featured: true, bestseller: false },
  { id: 50, name: 'A Luz do Mundo', slug: 'a-luz-do-mundo-preta', price: 99.9, priceCard: 109.9, collection: 'oversized', category: 'oversized', sizes: ['M', 'G', 'GG'], colors: ['Preto'], image: '/images/products/oversized/a-luz-do-mundo-preta.webp', description: 'Oversized preta "A Luz Do Mundo" com arte colorida.', featured: true, bestseller: false },
...
export const siteConfig = {
  ...
  whatsapp: '75991421714',
  whatsappDisplay: '+55 (75) 99142-1714',
